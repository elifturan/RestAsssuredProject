...
public class JsonToPOJO_Practice {
    ...
    public void testSpartanJsonToSpartanObject(){
        ...
        int newID = 80; //SecureSpartanTest.createRandomSpartan();
       ...
       //Spartan2 sp = new Spartan2(80,"Elma","Male",9999999998L);
        System.out.println("sp = " + sp);
/*
{  wwithout default constructor
    "timestamp": "2020-08-26T22:36:31.159+0000",
    "status": 404,
    "error": "Not Found",
    "message": "Spartan Not Found",
    "path": "/api/spartans/368"
}
sp = Spartan2{id=261, name='Elma', gender='Male', phone=9999999998}
 */
    }
