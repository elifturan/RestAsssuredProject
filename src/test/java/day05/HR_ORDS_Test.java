...
//allNames = [Europe, Americas, Asia, Middle East and Africa]
       ...
       // regionList = [Region{region_id=1, region_name='Europe'}, Region{region_id=2, region_name='Americas'}, Region{region_id=3, region_name='Asia'}, Region{region_id=4, region_name='Middle East and Africa'}]

        /*
        first region_name Europe
Get last region_id   4
Get last region_id   4
allNames = [Europe, Americas, Asia, Middle East and Africa]
