...
public class LibraryApp_API_DB_Test {
    ...
    private static String libraryToken ; //it is static because not belongs to obj it is belongs to class means will work
    //for each test in that class if needed it..
 ...
 */
    ...
    @Test
    public void test(){   //this part is JDBC
 ...
 //This part is API to verify the JDBC data'result
